...
public class RoomsControllerTests
{
    ...
    public RoomsControllerTests()
    {
        ...
        _controller = new RoomsController(_mockService.Object, _mockLogger.Object);
    }
    ...
    {
        //Arrange
        _mockService.Setup(s => s.GetAllAsync()).ReturnsAsync(new List<RoomDto>());
    ...
    {
        //Arrange
        _mockService.Setup(s => s.GetByIdAsync(99)).ReturnsAsync((RoomDto?)null);
    ...
    public async Task Create_ReturnsCreatedAtAction()
    {
        ...
        _mockService.Setup(s => s.CreateAsync(dto)).ReturnsAsync(new RoomDto 
        { 
            Id = 3, 
            Name = "Sala C" 
        });
